...
public class PermissionIntercept implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws IOException {
        ...
        if(validate != null){
            List<String> funcPerms = GlobalEnv.getClientCache().getValue(Constant.RESOURCE_KEY, DEFAULT_RESOURCE_PERMS).getValue(Constant.FUNCPERM_KEY, DEFAULT_FUNC_PERMS);
