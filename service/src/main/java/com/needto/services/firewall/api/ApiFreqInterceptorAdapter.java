package com.needto.services.firewall.api;

import com.needto.common.context.GlobalEnv;
import com.needto.common.entity.Result;
import com.needto.common.entity.Target;
import com.needto.common.services.firewall.api.ApiFreqLimit;
...
public class ApiFreqInterceptorAdapter extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        if (handler instanceof HandlerMethod) {
            com.needto.common.services.firewall.api.ApiFreqLimit apiFreqLimit = ((HandlerMethod) handler).getMethodAnnotation(ApiFreqLimit.class);
